...
import { Route as ALayoutRouteImport } from './app/routes/_a/_layout'
import { Route as ALayoutHomeIndexRouteImport } from './app/routes/_a/_layout/_home/index'
...
} as any).lazy(() => import('./app/routes/register.lazy').then((d) => d.Route))
const LoginLazyRoute = LoginLazyRouteImport.update({
  id: '/login',
  path: '/login',
  getParentRoute: () => rootRouteImport,
} as any).lazy(() => import('./app/routes/login.lazy').then((d) => d.Route))
